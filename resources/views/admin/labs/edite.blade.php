...
<section class="container">
    ...
    <div class="card border-info mb-3">
        <form class="form-horizontal" method="POST" action="{{ route('labs.update', $lab->id) }}">
            {{ csrf_field() }}
            ...
            <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="lab_name" class="form-control" name="lab_name" value="{{ (old('lab_name')) ? old('lab_name') : $lab->lab_name }}" placeholder="lab Name">
                        </div>
                    </div>

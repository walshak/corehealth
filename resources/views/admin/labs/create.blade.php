...
<section class="container">
    ...
    <div class="card border-info mb-3">
        {!! Form::open(array('route' => 'labs.store', 'method'=>'POST', 'class' => 'form-horizontal' )) !!}
                {{ csrf_field() }}
            ...
            <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="lab_name" class="form-control" name="lab_name" value="{{ old('lab_name') }}" placeholder="lab Name">
                        </div>
                    </div>

                    ...
                    <div class="callout callout-info">
                          ...
                          <div>
                              <div class="radio radio-primary radio-inline">
                                ...
                                @else 
                                  <input type="radio" name="s1" id="s1" value="1" checked>
                                @endif
                                <label for="s1">Terminus Shop</label>
                              </div>
                              <!-- <div class="radio radio-success radio-inline" hidden="1">
                                  <input type="radio" name="s1" id="s1_" value="2">
                                  <label for="s1_">Cash Regular Customer</label>
                              </div>
                              <div class="radio radio-danger radio-inline" hidden="1">
                        ...
                        <div class="form-group" id="dropMain" style="display: none;">
                            <div class="form-group">
                                ...
                                {!! Form::select('customer', $mycustomer , null, ['id' => 'customer', 'placeholder' => 'Please Select customer', 'class' => 'form-control']) !!}
                            </div>
                      ...
                      $.ajax({
                          ...
                          success:function(response)
                          {
                            ...
                            console.log(data);
                                ...
                                $('#current_quantity').val(data.product.current_quantity);

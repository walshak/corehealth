...
<!-- <div class="content-wrapper"> -->
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h3>
                    <i class="fa fa-globe"></i>MADAM CCC & SONS
                  </h3>
                  <h4>
                    <small class="float-left">SHENDAM MAIN PARK. Shendam Main Park, Shendam LGA Plateau State 
                      <br>08069652272, 07055579229,08162062773,08181135050.
                    </small>
                  </h4>
                ...
                <hr>    <div class="col-12">
                  <h4>
                    <i class="fa fa-certificate"></i>Invoice # :  {!! $tran->transaction_no !!}
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <b> <address>
                   ...
                   @else  <b style="color:Green">Paid </b>
                   @endif
                 </b>
                </div>
                <!-- /.col -->
                    ...
                    <tbody>
                     ...
                     ?>  
                       ...
                       @foreach ($sale as $sales) 
                            <tr>
                               <td align="left"> {{$si++}}</td>
                               <td align="left"> {!! $sales->product->product_name !!}</td>
                               <td align="left"> {{'₦'. $sales->sale_price}}</td>
                               <td align="left"> {{$sales->quantity_buy }}</td>
                               <td align="left"> {{'₦'. number_format($sales->total_amount)}}</td>
                            </tr>
             ...
             {{--    <div class="col-6">
                ...
                <!-- /.col -->
                    ...
                    <table class="table" >
                      <tr>
                        ...
                        <td colspan="5">{!! number_format($my_sums)!!}</td>

                      </tr>
                      <tr>
                        <th>Total Amount in Word:</th>
                        <th>
                           {!! convert_number_to_words($my_sums)!!} Naira Only</th>
                      </tr>
              ...
              <div class="row no-print">
                <div class="col-12">
                   <a href="{{ route('sales.show',$tran->id) }}"  class="btn btn-primary float-left" style="margin-left:5px;"><i class="fa fa-eye"></i>Edit Invoice</a>

                   <button class="btn btn-green waves-button waves-effect waves-light float-right"   onClick="window.print();" >PRINT</button>
  ...
  <div aling ="center" >  <a href="{{ route('sales.index') }}"  class="btn btn-success float-left" style="margin-left:5px;"><i class="fa fa-arrow-left"></i>Back</a></di>

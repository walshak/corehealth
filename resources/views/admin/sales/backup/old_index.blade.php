    ...
    <section class="content noprint">
        ...
        <div class="box box-primary">
            ...
            {{-- <div class="col-sm-offset-2 col-sm-10"> --}}
                {!! Form::open(array('route' => 'sales.store', 'method'=>'POST', 'role'=>'form', 'enctype' => 'multipart/form-data' )) !!}
                  ...
                  <div id="dropMain" style="display: none;">
                          ...
                          <div class="form-group">
                                            <label for="select" class="control-label">Mode of Payment:</label>
                                            <div class="">
                                                <select id="payment_mode" name="payment_mode" class="form-control selectpicker" data-style="btn-white" data-live-search="true">
                                                    <option value="5" >Credit Account</option>
                       ...
                       <table  class="table table-sm table-responsive table-bordered table-striped ">
                          ...
                          <tbody>
                            <tr>
                                ...
                                <td>
                                  <input type="text" name="piece_sprice"   id="pieces_price" placeholder=" pieces_price" class=" form-control" readonly="1" value="{{ old('pieces_price')  }}" />
                                </td> 
                                <td> 
                                  <input type="text" name="pieces_max_discount"   id="pieces_max_discount" placeholder=" max_discount" class=" form-control" readonly="1" value="{{ old('pieces_max_discount')  }}" />
                                </td>
                                <td>
                                    <input type="number" name="pieces_quantity"   id="pieces_quantity" placeholder=" pieces_quantity" class=" form-control" value="{{ old('pieces_quantity')  }}" />
                                </td>
                                <td>
                                    <input type="number" name="pdc"   id="pdc" placeholder=" pdc" class=" form-control" value="{{ old('pdc')  }}" />
                                </td>
          ...
          $("#showProperty").slideDown(500);
            ...
            total = ( $("#price").val() - parseInt($("#dc").val())) * parseInt($("#quantity").val()),
     ...
     //;
      ...
      DataPayLoad =  '[';
                  for (i = 0; i < dtTable.rows().count() -1; i++){
                     DataPayLoad += '{' + '"product":' + '"' + dtTable.cell(i,1).data() + '", "quantity":"' + dtTable.cell(i,2).data() + '", "total_amount":"' + dtTable.cell(i,3).data() + '", "price":"' +  dtTable.cell(i,4).data() + '"}, ';
                   }
                    DataPayLoad += '{' + '"product":' + '"' + dtTable.cell(i,1).data() + '", "quantity":"' + dtTable.cell(i,2).data() + '", "total_amount":"' + dtTable.cell(i,3).data() + '", "price":"' +  dtTable.cell(i,4).data() + '"}]';
      
      

        dataPL = {'trans': "{{$trans}}", 'customer':customer.val(), 'payment_mode':payment_mode.val(), 'payload' : DataPayLoad };

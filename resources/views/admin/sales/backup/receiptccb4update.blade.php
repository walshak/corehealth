                        ...
                        <section class="slice">
                            ...
                            <div id="invoice" class="paid">
                             ...
                             <!--    <table class=" print-font-size" width="100%" > -->
                                    <tr class="fontHeader">
                                      <td colspan="5" align="center" > <b>MADAM CCC & SONS</b></td>
                                    </tr>
                                    ...
                                    <tr class="rowHeight">
                                        ...
                                        <td colspan="4" class="idText" >08069652272, 07055579229.</td>
                                    </tr>
                                    ...
                                    <tr class="rowHeight">
                                        ...
                                        <td class="idText"> <label> Date: {!! $tran->tr_date !!}</label> </td>
                                      ...
                                      <!-- <div id="secondMain" class="borderRight borderLeft"> -->
                                        <table id="secondMain" class="table_style borderRight borderLeft" border="0">
                                          ...
                                          <thead>
                                              <tr class="idTextHead rowHeight rowData">
                                                  ...
                                                  <th class="rowData" width="47%">Item Description</th>
                                                  <th class="rowData2" width="9%">Price </th>
                                                  <th class="rowData2" width="9%">Qty</th>
                                                  <th class="rowData2" width="9%">Total </th>
                                              </tr>
                                          </thead>
                                          <tbody>
                                                <?php
                                                ...
                                                ?>
                                                    ...
                                                    @foreach ($sale as $sales) 
                                                       ...
                                                       <tr class="rowHeight" style="border-bottom: 1px solid #000;">
                                                                ...
                                                                <td class="idTextBold rowData" width="14%" align="left">{!! $sales->product->product_name !!}</td>
                                                                <td class="idTextBold rowData"> {{'₦'. $sales->sale_price}}</th>
                                                                <td class="idTextBold rowData">{{$sales->quantity_buy }}</td>
                                                                <td class="idTextBold rowData"> {{'₦'. number_format($sales->total_amount)}}</td>
                                                      </tr>
                                        ...
                                        <table class="table_style_footer" border="1">
                                            ...
                                            <tr class="rowHeight idTextBold">
                                                <td>  </td>
                                                 <td class="rowData" colspan="3" style="padding-right: 5px; text-align: left;">
                                                      {{'Grand Total'}}
                                                  </td>
                                                 <td class="rowData" style="padding-right: 0px; text-align: right;">
                                                      <b class="fontMoneyBig">
                                                        {!! number_format($my_sums)!!}
                                                      </b>
                                                 </td>
                                            </tr>
                                            <tr class="rowHeight ">
                                                 <td class="idTextBold">Amount in Word:</td>
                                                  <td colspan="4" class="idText">
                                                     {!! convert_number_to_words($my_sums)!!}
                                                 </td>

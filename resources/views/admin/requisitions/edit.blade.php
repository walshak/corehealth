        ...
        <div class="card-body">
            ...
            {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="store_name" name="store_name" value="{!! (!empty($store->store_name)) ? $store->store_name : old('store_name') !!}" required autofocus placeholder="Enter Store Name e.g (Musa Store, Store 1 etc)">
                    </div>
                </div>
                <div class="form-group">

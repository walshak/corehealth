  ...
  <link rel="stylesheet" href="{{ asset('../node_modules/sweetalert2/dist/sweetalert2.css') }}"  />
    <style type="text/css" media="print">
        ...
        /*@font-face{
            ...
            src: url({!! asset('fonts/digital-7/digital-7 (mono italic).ttf') !!});
    ...
    <style type="text/css">
        ...
        @media print{
            ...
            .idCardbgfront{
                ...
                background-image: url({!! asset('img/idcard/Supply note.png') !!});
            ...
            .idCardbgback{
                ...
                background-image: url({!! asset('img/idcard/back.jpg') !!});
        ...
        body {
            ...
            .idCardbgfront{
                background-image: url({!! asset('img/idcard/supply notee.png') !!});
                background-repeat: no-repeat;
                background-position: center center;
            }
            .idCardbgback{
    ...
    <style type="text/css">
        @font-face {
            ...
            font-style: normal;
            font-weight: normal;
            src: local('Digital-7 Mono Italic'), url('{!! asset("fonts/digital-7-mono-cufonfonts-webfont/digital-7 (mono italic).woff") !!}') format("woff"));
        }

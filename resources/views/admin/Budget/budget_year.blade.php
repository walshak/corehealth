        ...
        <div class="content-header">
          <div class="container-fluid">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Year Budget List</h1>
              </div>

              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Year Budget List</li>
                </ol>
              </div>
   ...
   $(function () {
    ...
    $('#products').DataTable({
        ...
        "drawCallback": function () {
            ...
            var sumSpending = $('#products').DataTable().column(5).data().sum();
            $('#subtotalSpending').html(sumSpending);
            var sumBalance = $('#products').DataTable().column(6).data().sum();

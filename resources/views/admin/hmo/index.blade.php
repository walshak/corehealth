        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('hmos.create') }}" class="btn btn-primary">New HMO</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="pull-right">
                        <!-- <a href="{{ route('hmos.create') }}" class="btn btn-primary" >New Role</a> -->
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-center">Are you sure you want to delete the following HMO?</h4>
                    <br />

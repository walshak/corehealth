                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center">
                            ...
                            {{-- <div class="form-group col-md-6 col-md-offset-3">
                                <h5>Search Parameter: <span class="text-danger"></span></h5>
                                <div class="controls">
                                    <input type="text" name="q" id="q" required class="form-control" placeholder="Enter Matriculation Number">
                                    <div class="help-block"></div>
                                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="{{ route('receptionists.store') }}" method="POST" role="form"
                        id="dependants_form">
                        {{ csrf_field() }}
    ...
    <script>
        ...
        $(document).on('click', '.edit-modal', function() {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ url('getMyDependants') }}/" + user_id,
                data: {
                    // 'id': $("#id_edit").val(),
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if ((data.errors)) {
                        ...
                        //window.location.href = "{!! route('receptionists.index') !!}";
                    }
                }
            });
            // }else{

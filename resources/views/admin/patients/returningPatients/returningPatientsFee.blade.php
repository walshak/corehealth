            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::open(['route' => 'returningPatientCardPayment', 'method' => 'POST', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{{ $userid }}" readonly="1">
                            <input type="hidden" name="patient" value="{{ $patient }}" readonly="1">
                            <input type="hidden" name="dependant_id" value="{{$dependant->id ?? ''}}" readonly="1">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="payment_mode" id="payment_mode" placeholder="Pick a Value"
                                        ...
                                        @isset($patient_account)
                                            <option value="from_account">Patient Account (₦{{$patient_account->deposit - $patient_account->creadit}})</option>
                                        @endisset
                                    </select>
                                    @isset($patient_account)
                            ...
                            <div class="box-footer" align="center">
                                <a href="{{ route('returningPatients') }}" class="btn btn-success"> Back</a>

  ...
  <div id="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Previous Consultation Patient List </h1>
          </div>

          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Previous Consultation  </li>
            </ol>
          </div>
    ...
    <div class="container">
        ...
        <div class="card">
                ...
                <h3 class="card-title">{{ __('Previous Consultation ') }}</h3>
                </div>

        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Patient Consultation Request List (Principals) ') }}</h3>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Patient Consultation Request List (Dependants) ') }}</h3>
                </div>
    ...
    <script>
        $(function() {
            $('#products').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ url('allConsultationRequestList') }}",
                    "type": "GET"
                },
                "columns": [{
                        data: "DT_RowIndex",
            ...
            $('#products2').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('ConsultationRequestListDependants') }}",
                    "type": "GET"
                },
                "columns": [{
                        data: "DT_RowIndex",

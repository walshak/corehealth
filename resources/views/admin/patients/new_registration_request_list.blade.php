		...
		<div class="content-header">
		  <div class="container-fluid">
		    ...
		    <div class="row mb-2">
		      ...
		      <div class="col-sm-6">
		        <h1 class="m-0 text-dark">Registration Request For Patients</h1>
		      </div>

		      <div class="col-sm-6">
		        <ol class="breadcrumb float-sm-right">
		          <li class="breadcrumb-item"><a href="#">Home</a></li>
		          <li class="breadcrumb-item active">Registration Request For Patients</li>
		        </ol>
		      </div>
...
<script>
  $(function () {
    $('#products').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "{{ url('NewRegistrationRequestList') }}",
            "type": "GET"
        },
        "columns": [

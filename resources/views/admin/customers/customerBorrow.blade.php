                    ...
                    <div class="col-md-9" align="center">
                        ...
                        <section class="slice">
                            ...
                            <div id="invoice" class="paid">
                             <!-- <table class=" print-font-size" width="100%" table-boder="2"> -->
                                 
                                     <table width=450 height=250 cellpadding="0" cellspacing="0" >
                                  <tr> 
                                        <td colspan="4" align="center" > <b>{!! $apps->site_name !!}</b>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="4" height="9">
                                           <label> Address:  </label> {!! $apps->contact_address !!}</td>
                                        
                                    </tr>
                                    <tr>
                                       
                                        <td colspan="4" height="9"> <label> Phone:  </label> {!! $apps->contact_phones !!}</td>
                                        
                                    </tr>

                                    <tr>
                                        <td colspan="4" height="9">
                                           <label> Bill To:  </label> {{  $trans->customer_name }} 
                                    ...
                                    <tr>
                                        <td colspan="4" height="9">
                                          ...
                                          <label> Receipt No:  </label> {{ $trans->transaction_no }}
                                        </td>
                                     </tr>
                                      <tr>
                                         <td height="9">
                                     
                                            <label> Status:<b style="color:green"> Borrow to Customer</b>  </label>
                                         </td height="9">
                                              <td colspan="2"><label> Date: 8888</label> </td>
                                               
                                        </td>
                                        
                                    </tr>
                                   </table>
                                   <table width=450 height=250 border=2 cellpadding="0" cellspacing="0">
                                   <thead>
                                   <tr>
                                        <td> Amount: </td>
                                        <td colspan="3">
                                       <b>{{ $trans->total_amount }}</b> 
                                    ...
                                    <tr>
                                     <td>Amount in Word: </td>
                                        <td colspan="3"  style="font-size:11px" height="9">
                                         {{ convert_number_to_words($trans->total_amount )}} Naira Only 
                                                ...
                                                <tr>
                                                 ...
                                                 @if($trans->current_credit)
                                                   <tr>
                                                          <td>Total Current Credit: </td>
                                                          <td colspan="3">
                                                            {{ $trans->current_credit}}
                                                           </td>

    ...
    <div class="card border-info mb-3">
        <div class="card-header bg-transparent border-info">
            <h3 class="card-title">
                ...
                <div class="clearfix">
                    <div class="float-left">{{ __('Client List') }} <small
                            class="badge badge-pill badge-dark">(Faculties/Directorates,
                            Department/Units)</small></div>
                    <div class="float-right">
                        <a class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="edit"
                            href="{{ route('customers.create') }}">
                            <i class="fa fa-plus text-warning"></i> Add Client
                        </a>
                    </div>
                </div>
            </h3>

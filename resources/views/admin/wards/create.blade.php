...
<section class="container">
    ...
    <div class="card border-info mb-3">
        {!! Form::open(array('route' => 'wards.store', 'method'=>'POST', 'class' => 'form-horizontal' )) !!}
                {{ csrf_field() }}
            ...
            <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="ward_name" class="form-control" name="ward_name" value="{{ old('ward_name') }}" placeholder="ward Name">
                        </div>
                    </div>

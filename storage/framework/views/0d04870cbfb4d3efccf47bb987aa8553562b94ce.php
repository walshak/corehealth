        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <h4>Active Image</h4>
                    <img src="<?php echo url('storage/image/user/' . $user->filename); ?>" valign="middle" width="150px" height="120px" />
                    <br>
                    <hr>
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="is_admin" name="is_admin" required
                            ...
                            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($status->id == $user->is_admin): ?>
                                    <option selected value="<?php echo e($status->id); ?>"><?php echo e($status->name); ?></option>
                                <?php else: ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo Form::select('users', $clientUsers, $user->customer_id, [
                            'id' => 'customer_id',
                            'name' => 'customer_id',
                            'placeholder' => 'Pick a
                                                Value',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="designation" name="designation"
                            value="<?php echo !empty($user->designation) ? $user->designation : old('designation'); ?>" autofocus>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="surname" name="surname"
                            value="<?php echo !empty($user->surname) ? $user->surname : old('surname'); ?>" autofocus>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="firstname" name="firstname"
                            value="<?php echo !empty($user->firstname) ? $user->firstname : old('firstname'); ?>" autofocus>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="othername" name="othername"
                            value="<?php echo !empty($user->othername) ? $user->othername : old('othername'); ?>" autofocus>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="title">Email:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="email" name="email" value="<?php echo !empty($user->email) ? $user->email : old('email'); ?>"
                            autofocus>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="phone_number" name="phone_number"
                            value="<?php echo !empty($user->phone_number) ? $user->phone_number : old('phone_number'); ?>" autofocus>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php echo !empty($user->content) ? $user->content : old('content'); ?>
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="visible" name="visible">
                            ...
                            <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($option->id == $user->visible): ?>
                                    <option selected value="<?php echo e($option->id); ?>"><?php echo e($option->name); ?></option>
                                <?php else: ?>
                ...
                <div class="form-group">
                    <div class="form-check checkbox-success checkbox-circle">
                        <input id="assignRole" type="checkbox" name="assignRole" <?php echo $user->assignRole ? 'checked="checked"' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo Form::select('roles[]', $roles, $userRole, ['id' => 'roles', 'class' => 'form-control select2', 'multiple', 'style' => 'width: 100%;', 'data-toggle' => 'select2', 'data-placeholder' => 'Select to assign role...', 'data-allow-clear' => 'true']); ?>
                ...
                <div class="form-group">
                    <div class="form-check checkbox-success checkbox-circle">
                        <input id="assignPermission" type="checkbox" name="assignPermission" <?php echo $user->assignPermission ? 'checked="checked"' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo Form::select('permissions[]', $permissions, $userPermission, ['class' => 'form-control select2', 'multiple', 'style' => 'width: 100%;', 'data-toggle' => 'select2', 'data-placeholder' => 'Select to assign permission...', 'data-allow-clear' => 'true']); ?>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mrapollos/Documents/database/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('main-content'); ?>
    ...
    <section class="content">
        ...
        <?php else: ?>
        <?php echo Form::open(['route' => 'medical-report.store', 'method' => 'POST', 'role' => 'form', 'enctype' => 'multipart/form-data', 'onsubmit' => 'set_diagnosis()']); ?>

        <?php endif; ?>
        <?php echo e(csrf_field()); ?>

        <input type="hidden" name="patient_user_id" value="<?php echo e($patient->user_id); ?>">
        <input type="hidden" name="dependant_id" id="dependant_id" value="<?php echo e($dependant->id ?? ''); ?>">
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select id="parm_sel" class="select2 form-control" style="min-width: 100%">
                                <option value="">select deug to add</option>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="nurseContent" name="nurseContent" cols="10" rows="2" class="form-control"
                                placeholder="Enter Instruction"
                                style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo e(old('nurseContent')); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('plugins/bootstrap-switch-master/dist/js/bootstrap-switch.min.js')); ?>"></script>
    <script src="<?php echo e(asset('plugins/datatables/jquery.dataTables.js')); ?>"></script>
    <script src="<?php echo e(asset('plugins/datatables/extensions/AutoFill/js/dataTables.autoFill.js')); ?>"></script>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mrapollos/Documents/database/resources/views/admin/patients/consultation_file.blade.php ENDPATH**/ ?>